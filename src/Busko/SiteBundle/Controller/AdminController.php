...
class AdminController extends Controller
{
    public function homeAction(Request $request)
    {
        ...
        return $this->render('BuskoSiteBundle:Admin:home.html.twig', array(
...
//        WHERE e.id in (SELECT o FROM Busko\EntityBundle\Entity\Operators o)');
    ...
    {
        return $this->render('BuskoSiteBundle:Admin:routes.html.twig',array('search'=>$request->get('search'),'search2'=>$request->get('search2')
